import 'package:app_mensajeria/screen/CallScreen.dart';
import 'package:app_mensajeria/screen/CameraScreen.dart';
import 'package:app_mensajeria/screen/ChatScreen.dart';
import 'package:app_mensajeria/screen/StatusScreen.dart';
          ...
          onPressed: () {
            ...
            return showDialog(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    title: Text("Contacto"),
                    content: Text("Desarrollado por Rodrigo Lara"),
                    elevation: 24.0,
                    ...
                    actions: <Widget>[
                      FlatButton(
                        ...
                        onPressed: () {
                          _launchURL(
                              "https://www.linkedin.com/in/RodrigoLara05/");
                        },
                      ),
                      FlatButton(
                        child: Text("Github"),
